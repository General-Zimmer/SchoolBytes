...
Scenario: C En participant kan kun tilmeldes fremtidige kurser
...
Scenario: D En participant med 5 aktive tilmeldte kurser, kan ikke tilmeldes
	Given Participant Bob med 5 aktive tilmeldte kurser
	When Bob bliver tilmeldt B
	Then Er der ikke en ny registration i DB B


Scenario: E En participant med fejl formateret data, tilmeldes ikke
...
Scenario: F En participant operettes ikke, hvis den allerede findes
